...
public class ConversorTemperatura {
	...
	public void converteFahrenheitParaCelsius() {
		...
		System.out.println("\nDeseja fazer uma nova convers�o?");
	...
	public void converteCelsiusParaFahrenheit() {
		...
		System.out.println("O valor convertido de Celsius para Fahrenheit � " + String.format("%.2f", conversao) + "�F");
		System.out.println("---------------------------------------------");
	...
	public void converteCelsiusParaKelvin() {
		...
		System.out.println("O valor convertido de Celsius para Kelvin � " + String.format("%.2f", conversao) + "K");
		System.out.println("---------------------------------------------");
	...
	public void converteKelvinParaFahreinheit() {
		...
		System.out.println("O valor convertido de Kelvin para Fahrenheit � " + String.format("%.2f", conversao) + "K");
		System.out.println("---------------------------------------------");
	...
	public void converteKelvinParaCelsius() {
		...
		double conversao = this.temperatura - 273.15;
		System.out.println("O valor convertido de Kelvin para Celsius � " + String.format("%.2f", conversao) + "�C");
		System.out.println("---------------------------------------------");
